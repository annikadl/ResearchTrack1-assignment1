...
To conclude, even though clarity had the highest priority, several improvements are possible, both in terms of the robot's behaviour and code efficiency.  However, the developed program fully accomplishes the assigned task. Furthermore, this Readme file provides a full description of the program's behaviour, operational and structural choices. 
